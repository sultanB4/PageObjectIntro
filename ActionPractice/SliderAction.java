...
//moveByOffset() --> it will move mouse from current location to provide location
        WebElement slider = driver.findElement(By.xpath("//input[@type='range']"));
        Actions actions = new Actions(driver);
        actions.clickAndHold(slider).moveByOffset(-55, 0)
                .release()
                .perform();
        //TASK --> keep moving to the slider with 0.5 if the values is not equals to 5.
    ...
    public void test2() {
        ...
        while (!number.getText().equals("5")) {
            ...
            xOffset += 10; //compound assigment in Java
        }
